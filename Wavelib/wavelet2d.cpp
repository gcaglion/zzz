...
string wtypeDesc(int wtype) {
	switch (wtype) {
	case WT_HAAR: return "haar";
	case WT_DB1: return "db1";
	case WT_DB2: return "db2";
	case WT_DB3: return "db3";
	case WT_DB4: return "db4";
	case WT_DB5: return "db5";
	case WT_DB6: return "db6";
	case WT_DB7: return "db7";
	case WT_DB8: return "db8";
	case WT_DB9: return "db9";
	case WT_DB10: return "db10";
	case WT_DB11: return "db11";
	case WT_DB12: return "db12";
	case WT_BIOR11: return "bior 1.1";
	case WT_BIOR13: return "bior 1.3";
	case WT_BIOR15: return "bior 1.5";
	case WT_BIOR22: return "bior 2.2";
	case WT_BIOR24: return "bior 2.4";
	case WT_BIOR26: return "bior 2.6";
	case WT_BIOR28: return "bior 2.8";
	case WT_BIOR31: return "bior 3.1";
	case WT_BIOR33: return "bior 3.3";
	case WT_BIOR35: return "bior 3.5";
	case WT_BIOR37: return "bior 3.7";
	case WT_BIOR39: return "bior 3.9";
	case WT_BIOR44: return "bior 4.4";
	case WT_BIOR55: return "bior 5.5";
	case WT_BIOR68: return "bior 6.8";
	case WT_COIF1: return "coif1";
	case WT_COIF2: return "coif2";
	case WT_COIF3: return "coif3";
	case WT_COIF4: return "coif4";
	case WT_COIF5: return "coif5";
	case WT_SYM2: return "sym2";
	case WT_SYM3: return "sym3";
	case WT_SYM4: return "sym4";
	case WT_SYM5: return "sym5";
	case WT_SYM6: return "sym6";
	case WT_SYM7: return "sym7";
	case WT_SYM8: return "sym8";
	case WT_SYM9: return "sym9";
	case WT_SYM10: return "sym10";
