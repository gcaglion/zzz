...
struct sOraData : sCfgObj {
	...
	EXPORT void getFlatOHLCV2(char* pSymbol, char* pTF, char* date0_, int pDate0Lag, int stepsCnt, int* cutStepsCnt, char** oBarTime, numtype* oBarData, char* oBarTime0, numtype* oBaseBar);
	//--
	EXPORT void open();
	EXPORT void close();
	EXPORT void commit();
