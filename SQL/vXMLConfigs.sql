...
union
select processid, NULL uHistoryLen, NULL uTopology, NULL MaxEpochs, substr(parmval,1,256) uSampleLen, NULL uDate0  from xmlconfigs where upper(parmdesc) like '%SAMPLELEN%'
union
