...
struct sSVM : sCore {
	EXPORT sSVM(sObjParmsDef, sAlgebra* Alg_, sCoreLayout* layout_, sCoreLogger* persistor_, sSVMparms* SVMparms_);
	EXPORT sSVM(sCfgObjParmsDef, sAlgebra* Alg_, sCoreLayout* layout_, sSVMparms* SVMparms_);
	EXPORT ~sSVM();
